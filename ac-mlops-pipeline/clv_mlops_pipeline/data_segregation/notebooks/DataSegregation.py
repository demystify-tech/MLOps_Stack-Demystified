...
# Retrieve the feature catalog name from the widget
feature_catalog = dbutils.widgets.get('feature_catalog')
...
yaml_root,config_path=get_config_paths('files',country_config,notebook_path)
country_config_values=yml_loader(config_path)
