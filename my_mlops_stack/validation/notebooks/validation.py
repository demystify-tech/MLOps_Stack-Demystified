...
X_validate = train_df.drop(ID_COL, LABEL_COL).toPandas()
y_validate = train_df.select(LABEL_COL).toPandas().values.ravel()
...
with mlflow.start_run(
    ...
    try:
        ...
        df_eval = X_validate.copy()
        df_eval[targets] = y_validate
