...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/ac-mlops-pipeline-tests-ci.yml) 
...
Links:
* [Staging model in UC](https://adb-51153483858903.3.azuredatabricks.net/explore/data/models/staging/ac-mlops-pipeline/ac-mlops-pipeline-model)
* [Prod model in UC](https://adb-4300203405439031.11.azuredatabricks.net/explore/data/models/prod/ac-mlops-pipeline/ac-mlops-pipeline-model)
. 
