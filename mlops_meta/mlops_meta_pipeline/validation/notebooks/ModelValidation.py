...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``ac_mlops_pipeline/resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in ac-mlops-pipeline/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in ac-mlops-pipeline/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-ac-mlops-pipeline-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.acda_ml.ac-mlops-pipeline-model", "Full (Three-Level) Model Name")
